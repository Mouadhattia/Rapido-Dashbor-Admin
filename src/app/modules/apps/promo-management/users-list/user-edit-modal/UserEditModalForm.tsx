...
const UserEditModalForm: FC<Props> = ({user, isUserLoading}) => {
  ...
  const [userForEdit, setUserForEdit] = useState<User>({
    ...
    imgPromo: user.imgPromo|| initialUser.imgPromo,
  ...
  const handleChangeImage = async (event: any) => {
    ...
    formData.append('image', event.target.files[0])
    uploadImage(formData).then(() =>
      setUserForEdit({...userForEdit, imgPromo: `${imagePath}/${event.target.files[0].name}`})
    )

    formik.setFieldValue('imgPromo', `${imagePath}/${event.target.files[0].name}`)
  }
      ...
      <form id='kt_modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        ...
        >
          ...
          <div className='fv-row mb-7'>
            {/* begin::Label */}
            <label className='d-block fw-bold fs-6 mb-5'>Image Produit</label>
            {/* end::Label */}
          ...
          {/* end::Input group */}
           ...
           <div className='fv-row mb-7'>
            {/* begin::Label */}
            <label className='d-block fw-bold fs-6 mb-5'>Image Offer</label>
            {/* end::Label */}
            ...
            <div
              className='image-input image-input-outline'
              data-kt-image-input='true'
              style={{backgroundImage: `url('${userForEdit.imgPromo}')`}}
            >
              {/* begin::Preview existing avatar */}
              <div
                className='image-input-wrapper w-125px h-125px'
