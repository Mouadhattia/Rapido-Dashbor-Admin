...
const USER_URL = `${API_URL}/menu`
const GET_RESTAURANT_URL = `${API_URL}/restaurant`

const getUsers = (query: string): Promise<UsersQueryResponse> => {
  return axios
    .post(`${USER_URL}/getAll`, query)
    .then((d: AxiosResponse<UsersQueryResponse>) => d.data)
}
const getRestaurant = (): Promise<UsersQueryResponse> => {
  return axios
    .post(`${GET_RESTAURANT_URL}/getAll`)
    .then((d: AxiosResponse<UsersQueryResponse>) => d.data)
}
